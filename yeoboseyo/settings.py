"""
Django settings for yeoboseyo project.
...
APPS_DIR = ROOT_DIR.path('yeoboseyo')
...
DATABASES = {
    'default': {
        ...
        'NAME': env.str('DB_NAME', default=BASE_DIR + '/' + 'yeoboseyo.sqlite3'),
    ...
    'TEST': {
        ...
        'NAME': BASE_DIR + '/' + 'yeoboseyo-test.sqlite3',
    }
}
...
INSTALLED_APPS = [
    'yeoboseyo.apps.YeoboseyoConfig',
...
WSGI_APPLICATION = 'yeoboseyo.wsgi.application'
